...
INSERT INTO settings (key, value, description) VALUES
  ...
  ('fee_schedule', '{"ebayFinalValueFeePct":0.1325,"ebayFixedFeePerOrder":0.30,"paymentProcessingPct":0.0,"gradingFeePsaRegular":65,"gradingUpchargeReserve":15,"insuredPostageAllocation":8,"outboundPostageDefault":4.5,"packagingDefault":1.5,"cardSaverCost":0.2,"sleeveCost":0.1,"gradingReturnShippingDefault":7,"gradingInsuranceDefault":3,"gradingUpchargeThreshold":500}', 'Default fee/cost schedule (GBP), editable in Settings UI. PSA Regular corrected to £65 (was incorrectly £25) to match the current UK service tier.');
